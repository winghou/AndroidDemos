...
public class SpanActivity extends AppCompatActivity {
    ...
    private static final String CONTENT = "Android中各种Span的用法";
    ...
    public void showRoundedBackgroundSpan(View view) {
        SpannableStringBuilder stringBuilder = new SpannableStringBuilder(CONTENT);
        stringBuilder.setSpan(new RoundedBackgroundSpan(Color.BLUE, 10), 0, 7, Spanned.SPAN_INCLUSIVE_INCLUSIVE);
        mTextView.setText(stringBuilder);
    }
}
