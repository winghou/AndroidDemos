...
public class LockPatternView extends View {
    ...
    public LockPatternView(Context context, AttributeSet attrs) {
        ...
        final String aspect = a.getString(R.styleable.LockPatternView_lpv_aspect);
        ...
        mRegularColor = a.getColor(R.styleable.LockPatternView_lpv_regularColor, mRegularColor);
        mErrorColor = a.getColor(R.styleable.LockPatternView_lpv_errorColor, mErrorColor);
        mSuccessColor = a.getColor(R.styleable.LockPatternView_lpv_successColor, mSuccessColor);

        int pathColor = a.getColor(R.styleable.LockPatternView_lpv_pathColor, mRegularColor);
    ...
    private void sendAccessEvent(int resId) {
        LockPatternUtils.announceForAccessibilityCompat(this, getContext().getString(resId));
    }
