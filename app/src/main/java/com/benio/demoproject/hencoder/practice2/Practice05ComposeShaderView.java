...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        Shader shader1 = new BitmapShader(BitmapFactory.decodeResource(getResources(), R.mipmap.batman),
                Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader shader2 = new BitmapShader(BitmapFactory.decodeResource(getResources(), R.mipmap.batman_logo),
                Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
